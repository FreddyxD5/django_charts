...
class Command(BaseCommand):
    help = 'Llena la base de datos con datos generados aleatoriamente'

    def add_arguments(self, parser):
        parser.add_argument("--amount", type=int, help="El numero de compras que deberian ser creadas")
    
    def handle(self, *args, **options):
        names = ["Jesus", "Fiorella", "Robert", "Michael", "Ana", "Jose","Ruth", "Anggie", "Angelica", "Clara"]
